...
public class AddressBookTextInterface
{
    ...
    private void change() {
        System.out.println("Type the name of the entry to change.");
        String key = parser.readLine();
        System.out.print("Please Enter New Phone Number: ");
        String phoneNum = parser.readLine();
        System.out.println("Please Enter New Address:  ");
        String address = parser.readLine();
        ContactDetails newDetails = new ContactDetails(key, phoneNum, address);
        try {
            book.changeDetails(key, newDetails);
        }
